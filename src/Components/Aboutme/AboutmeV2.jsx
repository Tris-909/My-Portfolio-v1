...
const MySkillTab = () => {
    return(
        <MySkillSection>
            ...
            <Row>
                <Column>HTML5</Column>
                <Column>CSS3, SCSS, SASS, LESS</Column>
                <Column>JavaScript ES6</Column>
            </Row>
            <Row>
                <Column>React</Column>
                <Column>Restful APIs</Column>
                <Column>Responsive Layout</Column>
            </Row>
            <Row>
                <Column>Styled Components, React Spectrum, AntDesign</Column>
            </Row>
            ...
            <Row>
                ...
                <Column> Experience working with both MacOS and Window  </Column>
            </Row>
        </MySkillSection>
    );
}
